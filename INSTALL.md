...
```bash
git clone https://github.com/TU-USUARIO/sistema-gestion-telebachillerato.git
...
| Paso | Acción |
|------|--------|
| 1 | En VS Code, haz clic derecho en la carpeta `gestion-universidad` |
| 2 | Selecciona `New File` |
| 3 | Nombra el archivo: `INSTALL.md` |
| 4 | Copia TODO el texto desde `# Instrucciones de Instalación` hasta `**¡Listo! El sistema está completamente funcional.** 🚀` |
| 5 | Pega en el archivo (`Ctrl + V`) |
| 6 | Guarda (`Ctrl + S`) |
